...
using Atividade1.Filmes;

Filme filme1 = new Filme("Creed - Nascido pra Lutar", 133, new List<string>() {"Michal B. Jordan", "Silvester Stalone", "Tessa Thompson", "Tony Bellew" });
Filme filme2 = new Filme("Creed 2", 130, new List<string>() {"Michal B. Jordan", "Silvester Stalone", "Tessa Thompson", "Florian Munteanu"});
